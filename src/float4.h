...
static_assert(offsetof(float4, x) == 0 * sizeof(float), "Invalid layout for float4");
static_assert(offsetof(float4, y) == 1 * sizeof(float), "Invalid layout for float4");
static_assert(offsetof(float4, z) == 2 * sizeof(float), "Invalid layout for float4");
static_assert(offsetof(float4, w) == 3 * sizeof(float), "Invalid layout for float4");
