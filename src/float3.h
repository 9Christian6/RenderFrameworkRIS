...
static_assert(offsetof(float3, x) == 0 * sizeof(float), "Invalid layout for float3");
static_assert(offsetof(float3, y) == 1 * sizeof(float), "Invalid layout for float3");
static_assert(offsetof(float3, z) == 2 * sizeof(float), "Invalid layout for float3");
